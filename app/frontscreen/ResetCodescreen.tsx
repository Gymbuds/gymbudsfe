...
type EnterResetCodeNavProp = NativeStackNavigationProp<RootStackParamList, 'EnterResetCode'>;
...
export default function EnterResetCodeScreen() {
  ...
  const handleVerifyCode = async () => {
    ...
    if (response.token) {
      ...
      Alert.alert("Invalid or expired reset code");
    }
  };
  ...
  return (
    <LinearGradient colors={["#F2ECFF", "#E5D4FF"]} style={tw`flex-1 justify-center items-center px-8`}>
      ...
      <Text style={tw`text-gray-600 mb-4`}>Please enter the reset code sent to your email:</Text>
